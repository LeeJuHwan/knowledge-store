...
* [Hands-on](comupter-architecture/hands-on/README.md)
...
* [Readable Code](java/readable-code/README.md)
  ...
  * [코드 다듬기](java/readable-code/코드_다듬기.md)
  * [읽기 좋은 코드를 도와줄 조언들](java/readable-code/읽기_좋은_코드를_도와줄_조언들.md)
* [Java 101](java/java-101/README.md)
  * [객체 지향 설계 5원칙 - SOLID](https://app.gitbook.com/o/NxS4yF2apiu9YKV9M4Bb/s/VJhVCjGzSpinr6v1FHUo/undefined/5-.-5-solid)
  * [동일성과 동등성](java/java-101/_.md)
  * [해시 코드](java/java-101/hashcode.md)
  * [JVM 이해하기](java/java-101/jvm.md)
  * [가비지 컬렉션](java/java-101/_-1.md)
  * [자바에서 정렬하는 방법](java/java-101/_-_.md)
  * [직렬화와 역직렬화](java/java-101/serializable.md)
  * [컬렉션 프레임워크](java/java-101/_-2.md)
  * [제네릭의 기본 이해](java/java-101/generic_basic.md)
  * [자바에서 스레드를 조작하는 방법](java/java-101/java_thread/README.md)
    * [동시성을 벗어나게 해줄 Thread Local](java/java-101/java_thread/thread-local.md)
    * [Thread 와 Runnable](java/java-101/java_thread/thread-runnable.md)
    * [Future 와 Callable 그리고 스레드 풀](java/java-101/java_thread/future-callable.md)
    * [스레드 풀을 새롭게 디자인하다](java/java-101/java_thread/fork-join-pool.md)
    * [Future 를 개선한 CompletableFuture](java/java-101/java_thread/future-completablefuture.md)
  * [런타임 도중 코드를 조작하는 마법, 리플렉션](java/java-101/reflection.md)
...
* [스프링 핵심 원리 - 기본편](spring-boot/spring-core-basic/README.md)
  ...
  * [스프링 핵심 원리 이해](spring-boot/spring-core-basic/spring-core/README.md)
    * [예제 만들기](spring-boot/spring-core-basic/spring-core/도메인_설계.md)
    * [객체 지향 원리 적용](spring-boot/spring-core-basic/spring-core/객체_지향_원리_적용.md)
    * [스프링 컨테이너와 스프링 빈](spring-boot/spring-core-basic/spring-core/스프링_컨테이너와_스프링_빈.md)
* [Practical Testing](spring-boot/practical-testing/README.md)
  * [테스트 사전 지식](spring-boot/practical-testing/테스트_사전_지식.md)
  * [스프링 레이어드 아키텍처 테스트하기](spring-boot/practical-testing/layerd-architecture-test/README.md)
    * [Persistence Layer](spring-boot/practical-testing/layerd-architecture-test/persistence-layer.md)
    * [Business Layer](spring-boot/practical-testing/layerd-architecture-test/business-layer.md)
    * [Presentation Layer](spring-boot/practical-testing/layerd-architecture-test/presentation-layer.md)
    * [Mock을 마주하는 자세](spring-boot/practical-testing/layerd-architecture-test/mock.md)
  * [더 나은 테스트를 작성하기 위한 가이드](spring-boot/practical-testing/test-advanced/README.md)
    * [한 문단에는 한 개의 주제만 담자](spring-boot/practical-testing/test-advanced/한_문단에는_한_개의_주제만_담자.md)
    * [완벽하게 제어하기](spring-boot/practical-testing/test-advanced/완벽하게_제어하기.md)
...
* [Java Playground](playgrounds/java-playground/README.md)
  * [숫자 야구 게임](playgrounds/java-playground/java-baseball/README.md)
    ...
    * [숫자 야구 게임 구현](playgrounds/java-playground/java-baseball/미션_리팩터링.md)
    * [숫자 야구 게임 다시 구현하기](playgrounds/java-playground/java-baseball/미션_다시구현.md)
  * [자동차 경주](playgrounds/java-playground/java-racing-car/README.md)
    * [문자열 덧셈 계산기](playgrounds/java-playground/java-racing-car/문자열_덧셈_계산기.md)
    * [자동차 경주 미션 구현](playgrounds/java-playground/java-racing-car/자동차경주_구현.md)
  * [좌표 계산기](playgrounds/java-playground/java-coordinate/README.md)
...
* [Infra Playground](playgrounds/infra-playground/README.md)
  ...
  * [Subway-Map](playgrounds/infra-playground/subway_map/README.md)
    * [망 구성하기](playgrounds/infra-playground/subway_map/망_구성하기.md)
    * [서버 구성하기](playgrounds/infra-playground/subway_map/서버_구성하기.md)
    * [화면 성능 개선하기](playgrounds/infra-playground/subway_map/화면_성능_개선하기.md)
  * [Conference Platform](playgrounds/infra-playground/conference_platform/README.md)
    * [망 구성하기](playgrounds/infra-playground/conference_platform/망_구성하기.md)
    * [서버 구성하기](playgrounds/infra-playground/conference_platform/서버_구성하기.md)
    * [화면 성능 개선하기](playgrounds/infra-playground/conference_platform/화면_성능_개선하기.md)
