...
![image](../../.gitbook/assets/osi7layer\_img03.png)
...
![image](../../.gitbook/assets/osi7layer\_img04.png)
...
![image](../../.gitbook/assets/osi7layer\_img05.png)
...
![image](../../.gitbook/assets/osi7layer\_img06.png)
...
1.  Local Network 외부로 통신 불가능
    ...
    ![image](../../.gitbook/assets/osi7layer\_img07.png)
...
*   특징: **서로 떨어진** Local Network간의 통신을 지원
    ...
    * 중간 중간 Node들을 거쳐서 목적지 까지 도달 할 수 있는 방법을 지원
    ...
    ![image](../../.gitbook/assets/osi7layer\_img08.png)
...
*   A.B.C.D/E 형식
    ...
    * E: 0 \~ 32: 네트워크 주소가 몇 Bit 인지 표시
    ...
    ![image](../../.gitbook/assets/osi7layer\_img09.png)
...
*   네트워크 비트 수 만큼 1을 보유한 마스크를 IP에 적용하면 네트워크 비트만 추출 가능
    ...
    ![image](../../.gitbook/assets/osi7layer\_img10.png)
...
* 흐름
  *   Broadcast -> MAC Address FF:FF:FF:FF:FF:FF로 IP 요청
      ...
      * 연결 되어있는 모두에게 해당 IP를 소유하고 있는지 물어봄
      ...
      ![image](../../.gitbook/assets/osi7layer\_img11.png)
  *   응답 받은 IP MAC Address를 기반으로 MAC 확정 후 테이블에 저장

      * IP를 갖고 있는 대상의 응답을 받아 테이블에 저장

      ![image](../../.gitbook/assets/osi7layer\_img12.png)
...
1.  라우터까지 데이터 전달하기
    ...
    * 이후 해당 MAC 주소로 Frame(Data Link Layer의 데이터 단위) 생성 후 전달
    ...
    ![image](../../.gitbook/assets/osi7layer\_img13.png)
2.  라우터에서 패킷을 분석하고 최적화 된 경로로 전달하기
    ...
    * 최적화 된 경로로 Frame 전달
    ...
    ![image](../../.gitbook/assets/osi7layer\_img14.png)
...
4.  목적지에 도착 하여 데이터를 전달
    ...
    * 프레임을 새로 생성 하여 목적지 대상에게 데이터 전달
    ...
    ![image](../../.gitbook/assets/osi7layer\_img15.png)
...
![image](../../.gitbook/assets/osi7layer\_img17.png)
...
*   TCP 세그먼트의 주요 구성
    ...
    * 실제 데이터
    ...
    ![image](../../.gitbook/assets/osi7layer\_img16.png)
...
![image](../../.gitbook/assets/osi7layer\_img18.png)
...
![image](../../.gitbook/assets/osi7layer\_img20.png)
...
![image](../../.gitbook/assets/osi7layer\_img19.png)
...
![image](../../.gitbook/assets/osi7layer\_img21.png)
...
![image](../../.gitbook/assets/osi7layer\_img22.png)
...
![image](../../.gitbook/assets/osi7layer\_img23.png)
...
* 받은 데이터를 해석하는 방법을 정의
  *   파싱, 압축 해제, 복호화 등 Application Layer에서 사용 할 수 있는 형식으로 변환을 담당
      ...
      ![image](../../.gitbook/assets/osi7layer\_img26.png)
...
![image](../../.gitbook/assets/osi7layer\_img27.png)
